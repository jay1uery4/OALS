...
<div id="pgside" class="drawer">
    ...
    <a href="Studentmodule.php" class="sidebar-btn active"><i class="ico fa fa-folder-open"></i><span class="txt">Modules</span></a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var btn = document.getElementById('add-module-btn');
    ...
    var form = document.getElementById('moduleUploadForm');
    form.onsubmit = function(e) {
        ...
        $.ajax({
            url: 'upload_module.php', // Backend script to handle the upload
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            success: function(response) {
                swal("Success", "Module uploaded successfully!", "success");
                form.reset(); // Clear the form
                modal.style.display = 'none'; // Close the modal
                // Optionally refresh the module list
            },
            error: function() {
                swal("Error", "There was a problem uploading the module", "error");
            }
        });
    }
});
