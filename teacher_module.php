...
<div id="pgside" class="drawer">
    ...
    <a href="teacher_module.php" class="sidebar-btn active"><i class="ico fa fa-folder-open"></i><span class="txt">Modules</span></a>
        ...
        <div class="dashboard-card">
            <div class="card-content">
                ...
                <div class="search-container">
                    ...
                    <button id="add-module-btn" class="btn-add-module">Add Module</button>
...
<!-- Modal Form for Uploading a Module -->
<div id="uploadModuleModal" class="modal">
    <div class="modal-content">
    <span class="close">&times;</span>
        <h3>Upload Module</h3>
        <form id="uploadModuleForm" action="upload_module.php" method="post" enctype="multipart/form-data">
...
<script src="Javascript/Teacher_module.js"></script>
</body>
</html>
